...
function renderArticleBody(article) {
  ...
  // Notion連携機能は後で実装予定
  // TODO: 記事投稿機能を実装したらNotion Rich Text変換を統合
  
  // Fallback: treat as HTML
  bodyEl.innerHTML = article.content || article.body || '';
...
// Load Notion article (placeholder - 後で実装予定)
async function loadNotionArticle(articleId) {
  // TODO: 記事投稿機能実装時にNotion API呼び出しを実装
  return null;
}
